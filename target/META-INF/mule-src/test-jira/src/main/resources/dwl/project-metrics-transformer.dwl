...
---
{
    "jiraMetrics": {
        "projectDetails": [
            {
                ...
                "projectKey": vars.project.key,
                "projectName": vars.project.name,
                "projectType": vars.project.projectTypeKey,
                "lead": vars.project.lead.displayName default "N/A",
                "description": vars.project.description default "No description"
            }
        ],
        "boardDetails": vars.boards map {
            ...
            "boardName": $.name,
            "boardType": $.'type',
            "projectKey": $.location.projectKey default vars.project.key,
            "projectName": $.location.projectName default vars.project.name,
